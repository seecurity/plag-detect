...
public class PlagResult {
    ...
    public boolean __eq__(PlagResult other){
        if (other == null)
            return false;
        else if ((this.getIdentifier().equals(other.getIdentifier())) && (Math.abs(this.getSimilarity() - other.getSimilarity()) < 0.0000001f ) && (this.getTiles().equals(other.getTiles())) && (this.getIdStringLength() == other.getIdStringLength()))
            return true;
        return false;
    }
